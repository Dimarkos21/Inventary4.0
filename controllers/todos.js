...
todosRouter.post("/", async (request, response) => {
    try {
        ...
        const { paciente,  cedula,  telefono,  patologia,  OD ,  OI , Adicion ,   DP , Resultados ,   Montura , Cristales ,fecha} = request.body;
        console.log( "datos ",paciente,  cedula,  telefono,  patologia,  OD ,  OI , Adicion ,   DP , Resultados ,   Montura , Cristales , fecha); //  los datos recibidos

        const newTodo = new Todo({
            paciente:paciente,  cedula:cedula,  telefono:telefono,  patologia:patologia,  OD:OD ,  OI:OI , Adicion:Adicion ,   DP:DP , Resultados:Resultados ,   Montura:Montura , Cristales:Cristales,fecha:fecha,
            checked: false,
            user: user._id
        });
